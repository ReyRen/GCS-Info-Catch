...
const (
	GcsInfoCatchServiceDocker_DockerContainerRun_FullMethodName    = "/proto.GcsInfoCatchServiceDocker/DockerContainerRun"
	GcsInfoCatchServiceDocker_DockerContainerDelete_FullMethodName = "/proto.GcsInfoCatchServiceDocker/DockerContainerDelete"
	GcsInfoCatchServiceDocker_DockerContainerStatus_FullMethodName = "/proto.GcsInfoCatchServiceDocker/DockerContainerStatus"
	GcsInfoCatchServiceDocker_DockerContainerLogs_FullMethodName   = "/proto.GcsInfoCatchServiceDocker/DockerContainerLogs"
	GcsInfoCatchServiceDocker_DockerLogStor_FullMethodName         = "/proto.GcsInfoCatchServiceDocker/DockerLogStor"
	GcsInfoCatchServiceDocker_NvmlUtilizationRate_FullMethodName   = "/proto.GcsInfoCatchServiceDocker/NvmlUtilizationRate"
)
...
func (c *gcsInfoCatchServiceDockerClient) DockerContainerRun(ctx context.Context, in *ContainerRunRequestMsg, opts ...grpc.CallOption) (GcsInfoCatchServiceDocker_DockerContainerRunClient, error) {
	stream, err := c.cc.NewStream(ctx, &GcsInfoCatchServiceDocker_ServiceDesc.Streams[0], GcsInfoCatchServiceDocker_DockerContainerRun_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gcsInfoCatchServiceDockerClient) DockerContainerDelete(ctx context.Context, in *DeleteRequestMsg, opts ...grpc.CallOption) (GcsInfoCatchServiceDocker_DockerContainerDeleteClient, error) {
	stream, err := c.cc.NewStream(ctx, &GcsInfoCatchServiceDocker_ServiceDesc.Streams[1], GcsInfoCatchServiceDocker_DockerContainerDelete_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gcsInfoCatchServiceDockerClient) DockerContainerStatus(ctx context.Context, in *StatusRequestMsg, opts ...grpc.CallOption) (GcsInfoCatchServiceDocker_DockerContainerStatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &GcsInfoCatchServiceDocker_ServiceDesc.Streams[2], GcsInfoCatchServiceDocker_DockerContainerStatus_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gcsInfoCatchServiceDockerClient) DockerContainerLogs(ctx context.Context, in *LogsRequestMsg, opts ...grpc.CallOption) (GcsInfoCatchServiceDocker_DockerContainerLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &GcsInfoCatchServiceDocker_ServiceDesc.Streams[3], GcsInfoCatchServiceDocker_DockerContainerLogs_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gcsInfoCatchServiceDockerClient) DockerLogStor(ctx context.Context, in *DockerLogStorReqMsg, opts ...grpc.CallOption) (*DockerLogStorRespMsg, error) {
	...
	err := c.cc.Invoke(ctx, GcsInfoCatchServiceDocker_DockerLogStor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gcsInfoCatchServiceDockerClient) NvmlUtilizationRate(ctx context.Context, in *NvmlInfoReuqestMsg, opts ...grpc.CallOption) (GcsInfoCatchServiceDocker_NvmlUtilizationRateClient, error) {
	stream, err := c.cc.NewStream(ctx, &GcsInfoCatchServiceDocker_ServiceDesc.Streams[4], GcsInfoCatchServiceDocker_NvmlUtilizationRate_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _GcsInfoCatchServiceDocker_DockerLogStor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GcsInfoCatchServiceDocker_DockerLogStor_FullMethodName,
	}
