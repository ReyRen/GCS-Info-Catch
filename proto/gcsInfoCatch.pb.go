...
type NvmlInfoRespondMsg struct {
	...
	MemRate         []uint64 `protobuf:"varint,3,rep,packed,name=memRate,proto3" json:"memRate,omitempty"`
...
func (x *NvmlInfoRespondMsg) GetMemRate() []uint64 {
	if x != nil {
		return x.MemRate
	}
	return nil
...
var file_gcsInfoCatch_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x04, 0x52, 0x07, 0x6d, 0x65, 0x6d, 0x52, 0x61, 0x74, 0x65, 0x12, 0x20, 0x0a, 0x0b,
